                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="input-group mb-3 ui-widget">
                                <input type="text" id="detalle_auto" class="form-control" placeholder="Ingrese numero de prestamo.." aria-label="Ingrese numero de prestamo" aria-describedby="button-addon1">
                            </div>
                        </div>
                    </div>
